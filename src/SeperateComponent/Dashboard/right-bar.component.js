import {
  ...
  const DashboardRightbarComponent = () => {
    ...
    return (
      <Box flex={2} p={2} sx={{ display: { xs: "none", sm: "block" } }}>
        ...
        >
            ...
            {/*<DropDownContainerComponent data={ data1 } />*/}
            <BriefComponent data={ data2 } />
            <HeadCountComponent data={ data3 } text="Catalog Overview" message="Manage Catalog" storage={true} />
  ...
  export default DashboardRightbarComponent;
