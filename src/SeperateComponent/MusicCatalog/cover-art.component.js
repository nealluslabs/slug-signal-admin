...
const CoverArtComponent = ({ show,file,fileFullDetails,name,uploadStatus,handleExpandIndex,indexToBeExpanded,uploadId,indexToBeRemoved,removeFile={},fileToDelete=null }) => {
...
const menuOptionsTemp = [
  ...
  { title: "Delete File", link: "", extra: false },
    ...
    return (
        <Box my={0.5} sx={{ display: "flex", alignItems: "center" }}>
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                   ...
                   <Box 
                    ...
                    <Box>
                        ...
                        {fileFullDetails.coverArtName? fileFullDetails.coverArtName.substring(0,maxChars)
                        :
                        fileFullDetails.coverArtUrl && new URL(fileFullDetails.coverArtUrl).pathname.split('/').pop().substring(0,maxChars)
                      }
                        </Typography>
