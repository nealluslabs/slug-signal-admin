...
const FileCreatorSelectComponent = ({ show,file,fileFullDetails,name,uploadStatus,handleExpandIndex,indexToBeExpanded,uploadId,indexToBeRemoved,removeFile={},fileToDelete=null }) => {
...
//
  //  },[lastDraggedFileType])
    ...
    return (
        <Box my={0}  mx={0} sx={{ display: "flex", alignItems: "center",background:"inherit"/*"#302c34"*/ ,borderBottom:"0.1px solid #606060",width:"100%" }}>
              ...
              <Menu
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                   ...
                   <Box onClick={()=>{allowedAudioTypes.includes(fileFullDetails.type)  && playAudio()}}
                    ...
                    >
                   {allowedAudioTypes.includes(fileFullDetails.type)?  (play?<IoPlayOutline style={{color:"black",fontSize:"1.3rem"}} />:<BsSoundwave style={{color:"black",fontSize:"1.3rem"}}/>): allowedImageTypes.includes(fileFullDetails.type)? <AiOutlinePicture style={{color:"black",fontSize:"1.3rem"}}/>: <IoDocumentOutline style={{color:"black",fontSize:"1.3rem"}}/>  }
                    </Box>  
                    ...
                    <Box sx={{position:"relative"}}>
                      ...
                      {/*EDITABLE NAME */}
                          ...
                          onMouseUp={(e) => { setIsEditable(true) }} // Enable editing on double-click
                          onBlur={() => setIsEditable(false)} // Disable editing when clicking outside
                          InputProps={{
                ...
                <Box sx={{ display: "flex", alignItems: "center"/*,opacity:"0",userSelect:"none"*/,gap:"0.7rem" }}>
                 ...
                 {/*   <HiOutlinePencil onClick={(e)=>{ dispatch(saveCurrentFileToEdit(fileFullDetails && fileFullDetails));setTimeout(()=>{setOpenModal(true)},1000 )  }} />
                <VscTrash onClick={(e)=>{deleteFileHandler(fileFullDetails && fileFullDetails.uploadId)}} /> */}
...
export default FileCreatorSelectComponent;
