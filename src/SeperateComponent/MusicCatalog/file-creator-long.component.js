...
const FileCreatorLongComponent = ({ show,file,fileFullDetails,name,uploadStatus,handleExpandIndex,indexToBeExpanded,uploadId,indexToBeRemoved,removeFile={},fileToDelete=null }) => {
...
//
  //  },[lastDraggedFileType])
    ...
    return (
        <Box my={0.7}  mx={1.2} sx={{ display: "flex", alignItems: "center",background:"#302c34" ,borderBottom:"0.1px solid #606060" }}>
...
export default FileCreatorLongComponent;
