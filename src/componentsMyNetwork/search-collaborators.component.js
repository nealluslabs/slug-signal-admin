...
const SearchBox = styled("div")(({ theme }) => ({
    ...
    borderBottom: "0.5px solid #606060", // Optional: Add a subtle border
...
const SearchCollaboratorsComponent = () => {
      ...
      >
        <DialogContent>
          <Box className={classes.contentBox}>
            ...
            <SearchBox>
            <SearchIconWrapper >
                    <FilterList style={{color:"#606060",fontWieght:"100"}} onClick={handleAnchorClick}/>
                </SearchIconWrapper>
                <SearchInput onChange={(e)=>{
                 ...
                 dispatch(saveSongSearchTerm(e.target.value))
                  ...
                  }} placeholder="search or filter collaborators..." />
...
export default SearchCollaboratorsComponent;
