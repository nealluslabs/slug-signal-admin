...
import PitchCreatedCard from 'src/components/listcards/pitch-created-card';
...
export default function PitchCreatedPage() {
 ...
 // }, [user]);
  ...
  return (
    <>
      ...
      <Container maxWidth="xl">
        ...
        <Grid item xs={8} md={12} lg={12}>
              <div style={{background: 'white',  padding: '10px',display:"flex",flexDirection:"column",gap:"1rem",position:"relative",left:"-3.2rem",backgroundColor:"transparent",marginBottom:"0.5rem"}}>
               ...
               <PitchCreatedCard pic={redboy} collection={'$9,500'} name={'NORMAN STEVEN'} uni={'Clark University'}/>
     ...
     {/**here 2 
     <Grid container spacing={1} sx={{background: '#F8F8F8',padding: '0px',width:"96.5%"}}>
          <Grid item xs={12} sx={{mb: 0}}>
        <p style={{fontSize:"24px",fontWeight:"600",position:"relative",top:"-1.2rem",left:"2.2rem"}}>Pitch</p>
         </Grid>
         ...
         <Grid item xs={12} sx={{mb: 0,position:"relative",top:"-2.6rem",left:"2rem"}}>
        ...
        /> 
         ...
         <Grid item xs={12} sx={{mb: 0,position:"relative",top:"-2.2rem",left:"2rem"}}>
