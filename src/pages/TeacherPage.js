...
import TeacherToggleSwitch from 'src/components/buttons/TeacherToggleSwitch';
import ViewTeacher from 'src/components/teacher/ViewTeacher';
import Step1 from 'src/components/students/Step1';
import AddTeacher from 'src/components/teacher/AddTeacher';
import { getTeachers } from 'src/redux/actions/student.action';
...
export default function TeacherPage() {
  ...
  return (
    <>
     ...
     <TeacherToggleSwitch activeButton={activeButton} setActiveButton={setActiveButton} handleOne={handleOne} handleTwo={handleTwo}/>
     <Grid item sx={{mb: 2}}>
        ...
        <Grid container spacing={2}>
            <Grid item xs={8} md={12} lg={12}>
              <div style={{background: '#F8F8F8',  padding: '10px'}}>
               {activeButton === '1' &&  <ViewTeacher teachers={teachers.length > 0 ? teachers : []}/>}  
               {activeButton === '2' && <AddTeacher />}
                </div>
            </Grid>
