 ...
 // }, [user]);
  ...
  return (
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={8} md={12} lg={6}>
            <div style={{ background: '#F8F8F8', padding: '10px' }}>
              <CampaignCard headerOne={'Statistics'} headerTwo={'Current Deal'} value={'$9,500'} type={'two'} image={redboy} />
            </div>
          </Grid>
    ...
    <Grid container spacing={2} sx={{ padding: '10px'}}>
        ...
        <p style={{fontSize:"24px",fontWeight:"600",position:"relative",top:"-1.2rem",left:"2rem"}}>Pitches</p>
         </Grid>
     ...
     <FormControl sx={{ minWidth: 140, background: 'white' }}>
          ...
          >
           ...
           <StudentFinanceStats students={students}/> 
            </div>
            </Grid>
